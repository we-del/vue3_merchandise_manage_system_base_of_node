...
import basic_vertex from '../shader/water_glsl/vertex.glsl'
import basic_fragColor from '../shader/water_glsl/fragColor.glsl'
...
class ViewScene {
  ...
  public useShader(): void {
    ...
    this.renderer.toneMapping = ACESFilmicToneMapping; // 设置渲染效果
    ...
    const boxRealGeometry = new PlaneGeometry(1, 1, 509, 590)
